...
function ensureP1WeeklyPanel() {
  ...
  const panel = document.createElement("details"); panel.id = "p1WeeklyPanel"; panel.className = "panel low-frequency-panel home-order-7";
...
function renderP1WeeklyStats() {
  ...
  const rows = [
    ...
    ["训练", `${stats.training.completed}/${stats.training.planned}`],
  ];
