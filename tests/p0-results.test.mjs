...
assert.match(professionalSource, /直接自由专注/);
assert.match(professionalSource, /dataset\.reviewFocusMode = "free"/);
...
assert.match(tasksSource, /function startReviewFreeFocusRound/);
